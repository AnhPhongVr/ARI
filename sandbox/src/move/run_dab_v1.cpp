...
void createArmClient2(arm_control_client_Ptr& actionClient)
{
  ROS_INFO("Creating action client to arm controller ...");
...
int main(int argc, char** argv)
{
  ...
  arm_control_client_Ptr ArmClient2;
  createArmClient2(ArmClient2);
  ...
  ArmClient2->sendGoal(arm_goal2);

  // Wait for trajectory execution
  while(!(ArmClient->getState().isDone() && ArmClient2->getState().isDone()) && ros::ok())
  {
